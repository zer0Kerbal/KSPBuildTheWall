...
tags: SafetyWall,adoption,NCAT,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
[![SafetyWall Version][MOD:shd:stat]][MOD:forum] [![KSP version][KSP:shd:stat]][KSP:url]
...
<p style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center">Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/SafetyWall/files">CurseForge</a></p>
...
* Issues
  * closes #4 - SafetyWall 1.2.0.0-adoption `<SafetyFirst!>`
  * closes #5 - 1.2.0.0 Verify Legal Mumbo Jumbo
  * closes #6 - 1.2.0.0 Update Documentation
  * closes #7 - 1.2.0.0 Create Social Media
...
[MOD:issue]: https://github.com/zer0Kerbal/SafetyWall/issues "Issue Tracker"
[MOD:known]: https://github.com/zer0Kerbal/SafetyWall/wiki/Known-Issues "Known Issues"
[MOD:licns]: https://github.com/zer0Kerbal/SafetyWall/blob/master/LICENSE "Repo License"
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/SafetyWall%20(NCAT)%20-v1.2.0.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen "1.2.0.0-adoption"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/SafetyWall/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?labelColor=black&style=plastic "AVC-Valid - thank you to DasSkelett"
