...
* Issues
  * closes #2 - SafetyWall 1.2.0.0-adoption `<SafetyFirst!>`
  * closes #3 - 1.2.0.0 Verify Legal Mumbo Jumbo
  * closes #4 - 1.2.0.0 Update Documentation
  * closes #5 - 1.2.0.0 Create Social Media
...
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/207496-*/ "NyanCat forum thread"
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/NyanCat%20(NCAT)%20-v1.2.0.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen "1.2.0.0-adoption"
